...
pthread_mutex_t mutex; //Declara mutex para los hilos, evit condiciones de carrera cuando hay varios hilos
int saldo = 0; //Inicializa la variable de "saldo"
 ...
 void * realizarRetiro(void* arg) { //Función para realizar un retiro 
    ...
    printf("Saldo restante: %d\n", saldo); //Imprime elsaldo restante 
    pthread_mutex_unlock(&mutex); 
    //Desbloquea el mutx, permitiendo que otros hilos acedan a "saldo"
